...
contract("Election", function(accounts) {
  ...
  it("it initializes the candidates with the correct values", function() {
    return Election.deployed().then(function(instance) {
      ...
      assert.equal(candidate[1], "Narendra D Modi", "contains the correct name");
      ...
      assert.equal(candidate[1], "Akhilesh Yadav", "contains the correct name");
      assert.equal(candidate[2], "Samajvadi Party", "contains the correct party");
      assert.equal(candidate[3], 0, "contains the correct votes count");
      return electionInstance.candidates(4);
    }).then(function(candidate) {
      assert.equal(candidate[0], 4, "contains the correct id");
      assert.equal(candidate[1], "Mamta Banarjee", "contains the correct name");
      ...
      assert.equal(candidate[1], "Mayavti", "contains the correct name");
